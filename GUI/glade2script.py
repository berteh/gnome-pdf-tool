...
class LoadConfig(object):
    ...
    def set_bool_int_widgets(self, section, gettype, gtkfunction):
        for option in self.options(section):
            ...
            self.ENV['G2S%s'%option] = str_value
...
class Callbacks(object):
    ...
    *** Widgets toggle, management via dictionnary
    ...
    def toggle_sensitive(self, widget, event=None,arg=None):
        ...
        self.set_dic_widget(widget, 0)
        widget.set_sensitive( self.dic_widget_state[name][0] )
    ...
    def toggle_visible(self, widget, event=None,arg=None):
        ...
        '''
        name = widget.get_name()
        if self.dic_widget_state[name][1]:
            widget.hide()
        else:
            widget.show()
        self.set_dic_widget(widget, 1)
    ...
    def toggle_active(self, widget, event=None,arg=None):
        ...
        name = widget.get_name()
        self.set_dic_widget(widget, 2)
        widget.set_active( self.dic_widget_state[name][2] )    

    def set_dic_widget(self, widget, place):
        name = widget.get_name()
        if self.dic_widget_state[name][place]:
            self.dic_widget_state[name][place] = False
        else: 
            self.dic_widget_state[name][place] = True
    ...
    *** combobox, spinbutton, calendar, data input zone, scale,
    ...
    def on_menu(self,widget,event=None,arg=None):
        '''
        @brief right click launch contextmenu (deprecated, please, use on_menu_right)
    ...
    *** radio, check, toggle button
    ...
    def on_toggled(self, widget,event=None,arg=None):
        ...
        self.dic_widget_state[nom][2] = value
        if import_py is not None:
    ...
    ********************
    ...
    def parse_xml(self):
        ...
        for node in l:
            ...
            self.dic_widget_state[name] = [True, False, False]
    ...
    def active(self, nom, data):
        if data =='True':
            self.dic_widget_state[nom][2] = True

    def visible(self, nom, data):
        if data =='True':
            self.dic_widget_state[nom][1] = True

    def sensitive(self, nom, data):
        if data =='False':
            self.dic_widget_state[nom][0] = False
...
class GuiTreeview(object):
    ...
    ******************************
    ...
    def iter_copy(self, model_source, model, iter_to_copy, target_iter, pos):
